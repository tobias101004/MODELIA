"""
Final application for generating 211 files for Spanish tax authorities
"""
...
async def procesar_pdf(
    ...
    try:
        ...
        try:
            ...
            # Return the extracted data and text
            return {
                "text": text,
                "suggested_data": extracted_data,
...
async def generar_211(
    data: Dict[str, Any] = Body(...)
):
    """Generate .211 file from structured data"""
    try:
        logger.info("Generating 211 file from submitted data")
